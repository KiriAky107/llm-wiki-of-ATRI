...
| 类别 | 项目 | 占用 | 状态 |
|:---|:---|:---|:---|
| 数据卷 | `filesreadsystem_backend_data` | 20K | ⏸️ 保留待定 |
| 数据卷 | `filesreadsystem_mongodb_data` | **511M** | ⏸️ 保留待定 |
| 数据卷 | `filesreadsystem_mysql_data` | **189M** | ⏸️ 保留待定 |
| 数据卷 | `filesreadsystem_redis_data` | 12K | ⏸️ 保留待定 |
| 镜像 | `filesreadsystem-backend` | 6.3G | ⏸️ 保留待定 |
| 镜像 | `filesreadsystem-celery_worker` | 6.3G | ⏸️ 保留待定 |
| 镜像 | `filesreadsystem-frontend` | 63.3M | ⏸️ 保留待定 |
| 源码目录 | `/www/FilesReadSystem` | 待测 | ⏸️ 保留待定 |

> ⚠️ 数据卷 / 镜像 / 源码目录为**不可逆**操作，按「不确定绝不擅自动手」原则，已列出待主人明确授权后再执行。
